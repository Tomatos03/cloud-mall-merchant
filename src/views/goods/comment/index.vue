        ...
        <el-card shadow="never" class="mb-6 border-none rounded-xl!">
            <div class="flex flex-wrap gap-6 items-center">
                ...
                <div class="flex gap-3 ml-auto">
                    ...
                    <el-button @click="handleReset" class="rounded-lg! px-6"> 重置 </el-button>
                </div>
            </div>
        </el-card>
                    ...
                    <div class="flex gap-6 p-5">
                        ...
                        <div class="relative shrink-0">
                            <el-image
                                ...
                                class="w-24 h-24 rounded-lg shadow-sm border border-gray-100"
                                fit="cover"
                            >
                                <template #error>
                                    <div
                        ...
                        <div class="flex-1 min-w-0">
                            ...
                            <div class="flex justify-between items-start mb-3">
                                <div>
                                    <h4
                                        class="text-lg font-bold text-gray-800 hover:text-blue-600 transition-colors cursor-pointer truncate"
                                    >
                                        {{ item.goodsName }}
                                    </h4>
                                    <div
                                        class="flex items-center gap-4 mt-1.5 text-xs text-gray-500"
                                    >
                            ...
                            <!-- 评价内容 -->
                            <div
                                class="relative bg-white border border-gray-100 p-4 rounded-xl mb-4 group-hover:border-blue-100 transition-colors"
                            >
                                <div
                                    class="absolute -top-2 left-4 px-2 bg-white text-[10px] font-bold text-blue-500 uppercase tracking-wider"
                                >
                                    买家评价
                                </div>
                            ...
                            <div
                                v-if="item.reply"
                                class="relative bg-blue-50/50 border border-blue-100/50 p-4 rounded-xl"
                            >
                                <div
                                    class="absolute -top-2 left-4 px-2 bg-blue-50 text-[10px] font-bold text-green-600 uppercase tracking-wider"
                                >
                                    我的回复
                                </div>
...
<script setup lang="ts">
    ...
    import type { CommentItem, CommentPageParams } from '@/api/comment'
    import { fetchCommentPage, replyComment } from '@/api/comment'
    ...
    const loadData = async () => {
        ...
        try {
            ...
            const res = await fetchCommentPage(params)
    ...
    const onReply = async (row: CommentItem) => {
        ...
        await replyComment(row.commentId, value)
